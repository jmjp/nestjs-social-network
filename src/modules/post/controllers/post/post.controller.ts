...
export class PostController {
    ...
    @Get()
    async findAll(@Req() req: Request, @Query() pagination: Pagination, @Res() res: Response) {
        const user = req.query.user;
        const posts = await this.postService.posts(user == undefined ? undefined : {
            where: {
    ...
    @Post()
    async create(@Req() req: Request, @Body() body: PostEntry, @Res() res: Response) {
